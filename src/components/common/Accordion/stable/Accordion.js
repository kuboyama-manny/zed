...
class Accordion extends React.Component {
  static propTypes = {
    ...
    openRacehorseModal: PropTypes.func,
    openBreedModal: PropTypes.func,
    openSellModal: PropTypes.func,
          ...
          {panels.map((panel, index) =>
            ismobile() ? (
              ...
              <Panel
                ...
                data={panel}
                activateTab={this.activateTab.bind(null, index)}
                openRacehorseModal={this.props.openRacehorseModal}
                openBreedModal={this.props.openBreedModal}
                openSellModal={this.props.openSellModal}
                openShareModal={this.props.openShareModal}
                openOffspringNameModal={this.props.openOffspringNameModal}
